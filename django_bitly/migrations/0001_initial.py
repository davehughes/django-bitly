...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('django_bitly_stringholder', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('absolute_url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal('django_bitly', ['StringHolder'])

        # Adding model 'Bittle'
        db.create_table('django_bitly_bittle', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('django_bitly', ['Bittle'])


    def backwards(self, orm):
        # Deleting model 'StringHolder'
        db.delete_table('django_bitly_stringholder')

        # Deleting model 'Bittle'
        db.delete_table('django_bitly_bittle')
